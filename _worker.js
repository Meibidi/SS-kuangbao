...
const U=new Uint8Array([207,164,66,231,10,98,92,23,153,27,78,44,147,137,198,95]),M=new Uint8Array(32768),P=[],TD=new TextDecoder,H=new Uint8Array(2),
...
const F=()=>{!t&&P.length<12&&s.buffer.byteLength===s.length&&s.buffer.byteLength<=4096&&P.push(s)}
...
n>z&&w.write(s.subarray(z)).catch(T)
F()
