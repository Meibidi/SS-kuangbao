...
M=new Uint8Array(32768),Q=Array(12),H=new Uint8Array(2),E=[new Response(null,{status:400}),new Response(null,{status:502})],
...
const[x,p,e]=A(s),k=await B(x,p)||await B('kr.tp50000.netlib.re',50000);if(!k){R();return E[1]} //Proxyip
...
w.accept();w.send(H);W.set(w,f);z>e&&g.write(s.subarray(e)).catch(()=>f[0]=0);R()
